...
model = dict(
    decode_head=dict(
        ...
        shadow_core_recall_loss_weight=0.12,
        shadow_core_recall_margin=0.90,
...
work_dir = "work_dirs/pen_istd_penonly_then_core_recall_mid_balanced_1k"
