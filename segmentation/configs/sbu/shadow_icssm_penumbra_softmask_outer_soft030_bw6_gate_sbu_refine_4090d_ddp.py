# Narrow-band outer penumbra soft-mask gate (band_width=6).
#
...
model = dict(
    decode_head=dict(
        ...
        soft_mask_loss_weight=0.30,
        penumbra_band_width=6,
...
work_dir = (
    "./work_dirs/"
    "shadow_icssm_penumbra_softmask_outer_soft030_bw6_gate_sbu_refine_4090d_ddp"
)
