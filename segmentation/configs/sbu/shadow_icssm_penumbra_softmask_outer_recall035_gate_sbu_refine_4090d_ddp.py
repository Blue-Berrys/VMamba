# Stronger recall-guard outer penumbra soft-mask gate (Tversky 0.35).
#
...
work_dir = (
    "./work_dirs/"
    "shadow_icssm_penumbra_softmask_outer_recall035_gate_sbu_refine_4090d_ddp"
)
