...
model = dict(
    decode_head=dict(
        ...
        shadow_core_recall_loss_weight=0.20,
        shadow_core_recall_margin=1.0,
...
optim_wrapper = dict(
    ...
    optimizer=dict(type="AdamW", lr=5e-5, betas=(0.9, 0.999), weight_decay=0.0),
    paramwise_cfg=dict(
        custom_keys={
...
work_dir = "work_dirs/pen_istd_from_istd_segcal_core_recall_1k"
