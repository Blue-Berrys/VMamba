...
train_dataloader = dict(batch_size=4, num_workers=4, persistent_workers=True, sampler=dict(type='InfiniteSampler', shuffle=True))
...
optim_wrapper = dict(_delete_=True, clip_grad=dict(max_norm=1, norm_type=2), optimizer=dict(type='SGD', lr=0.0025, momentum=0.9, weight_decay=0.0005), type='AmpOptimWrapper', accumulative_counts=1)
