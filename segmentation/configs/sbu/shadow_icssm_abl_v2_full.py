...
# Row 4: IC-SSM + BG-SIR + Tversky (Full model)
# Focal(0.7) + Dice(0.3) + Tversky(0.5, β=0.7)
_base_ = [
...
model = dict(
    ...
    decode_head=dict(
        ...
        boundary_kernel=5,
        tversky_loss_weight=0.5,   # Tversky 开启
        tversky_alpha=0.3,
        tversky_beta=0.7,
        use_bg_sir=True,           # BG-SIR 开启
        dropout_ratio=0.1,
        num_classes=2,
        align_corners=False,
        loss_decode=[
...
work_dir = './work_dirs/shadow_icssm_abl_v2_full'
