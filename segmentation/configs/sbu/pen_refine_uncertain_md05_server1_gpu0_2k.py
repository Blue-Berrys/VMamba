# Conservative uncertainty-gated penumbra logit refinement on the current
# soft-mask mainline. Unlike the plain soft-mask runs, this explicitly trains
# penumbra_logit_scale_raw so the confidence head can feed back to the binary
# mask only around uncertain boundary pixels.
...
model = dict(
    decode_head=dict(
        ...
        penumbra_refine_margin=1.0,
        penumbra_refine_sharpness=4.0,
...
work_dir = "work_dirs/pen_refine_uncertain_md05_server1_gpu0_2k"
