...
launcher = 'none'
load_from = 'work_dirs/shadow_icssm_penumbra_softmask_outer_soft029_bw4_gpu0_5k/best_BER_iter_4000.pth'
log_level = 'INFO'
...
model = dict(
    ...
    decode_head=dict(
        ...
        num_classes=2,
        penumbra_band_width=12,
        penumbra_grad_loss_weight=0.05,
        penumbra_mono_loss_weight=0.02,
        penumbra_width_loss_weight=0.10,
        penumbra_width_uncertain_gate=True,
...
param_scheduler = [
    dict(begin=0, by_epoch=False, end=300, start_factor=0.3, type='LinearLR'),
    dict(
        begin=300,
        by_epoch=False,
        end=30000,
    ...
    dataset=dict(
        ...
        pipeline=[
            ...
            dict(
                ...
                type='RefineAdaptivePenumbraAnnTransform'),
            dict(keep_ratio=False, scale=(
                512,
                512,
            ), type='Resize'),
...
work_dir = 'work_dirs/pen_adaptive_width_rgb_uncertaingate_5070_500'
